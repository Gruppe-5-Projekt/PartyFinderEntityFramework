...
namespace PartyFinderService.ModelConversion
{
    public class EventDataReadDTOConvert
    {
        ...
        public static EventDataReadDTO FromEvent(Event inEvent)
        {
            ...
            if (inEvent != null)
            {
                anEventReadDTO = new EventDataReadDTO(inEvent.Id, inEvent.EventName, inEvent.EventCapacity, inEvent.StartDateTime, inEvent.EndDateTime, inEvent.Description, inEvent.ProfileId);
